...
# Ordre logique des catégories (adapte si nécessaire à tes labels exacts)
org_order = [
    "Small (1–19)",
    "Medium (20–199)",
    "Large (200–499)",
...
fig = px.violin(
    ...
    category_orders={"Organisation_Size": org_order},
    box=True,
    points=False,   # enlève les points → plus clean
...
# Moyennes par taille d’organisation
means = (
    df.groupby("Organisation_Size", observed=False)
      ["Productivity_remote_vs_workplace"]
      .mean()
      .reindex(org_order))
