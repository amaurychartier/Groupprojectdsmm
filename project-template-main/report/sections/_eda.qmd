...
To test correlation we put the percentage of remote work with the change of productivity. 
```{python}
fig = px.scatter(
    df,
...
We can see here a positive correlation which infers that when you spend more time remotely your productivity rises. In causality it could be interpreted as a good signal.  But the coefficient is of 0.14 so a low positive correlation.  
