...
## Sources
**Describe test the sources of your data, such as public datasets, API collections, or scraped data.** 
...
raw_data_path = project_root / "data" / "raw" / "2020_rws-updated.csv"
...
print(f"Dataset shape: {data2.shape[0]} rows × {data2.shape[1]} columns")
...
As the analysis progresses, if additional categories are found to be too small to contribute meaningfully, they will be removed, flagged, or when conceptually appropriate grouped together with similar categories to preserve statistical power.
