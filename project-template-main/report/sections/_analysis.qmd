...
〖"Productivity" 〗_i=β_0+β_1 " " 〖"RemoteShare" 〗_i+ε_i
...
tmp = df[vars_extended + ['Productivity_remote_vs_workplace']].dropna()

X = sm.add_constant(tmp[vars_extended])
y = tmp['Productivity_remote_vs_workplace']
...
〖"Productivity" 〗_i=β_0+β_1 " " 〖"RemoteShare" 〗_i+β_2 " " 〖"Age" 〗_i+β_3 " " 〖"OrganisationSize" 〗_i+β_4 " " 〖"ManagingPosition" 〗_i+β_5 " " 〖"OrgEncouragement" 〗_i+β_6 " " 〖"Collaboration" 〗_i+ε_i
