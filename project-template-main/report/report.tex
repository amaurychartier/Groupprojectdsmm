...
\begin{tcolorbox}[enhanced jigsaw, breakable, opacityback=0, bottomrule=.15mm, bottomtitle=1mm, colback=white, opacitybacktitle=0.6, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Dataset Overview Template}, colframe=quarto-callout-note-color-frame, arc=.35mm, coltitle=black, toptitle=1mm, leftrule=.75mm, titlerule=0mm, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm]
